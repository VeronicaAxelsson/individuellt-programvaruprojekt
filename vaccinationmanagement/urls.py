...
urlpatterns = [
    ...
    path(
        'staff/patients/<int:patient_id>/add-dose/<int:vaccination_id>',
        views.add_dose,
        name='add-dose'
    ),
    path(
        'staff/patients/<int:patient_id>/add-vaccination',
        views.add_vaccination,
        name='add-vaccination'
    ),
    path(
        'staff/patients/<int:patient_id>/history/<int:vaccin_id>',
        views.vaccination_history,
        name='vaccination-history'
    ),
    path(
        'private/<int:patient_id>/vaccinations/history/<int:vaccin_id>',
        views.private_vaccination_history,
        name='private-vaccination-history'
    ),
    path('staff/vaccins', views.vaccins, name='vaccins'),
    path('private/home', views.private, name='private'),
    path('private/vaccinations', views.private_vaccinations, name='vaccinations'),
